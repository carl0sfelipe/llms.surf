# DISCOVERY — hermes
Data: 2026-07-24T22:03:29Z
Binário: <home-do-dono>/.local/bin/hermes
Comando: hermes --help
```
...
Comando: hermes sessions --help
```
usage: hermes sessions [-h]
                       {list,export,delete,prune,archive,optimize,repair,stats,rename,browse}
                       ...
