...
- Every failure becomes an incident; every recurring incident becomes code that refuses. **122 postmortems in this cut.**
...
[![Incidents](https://img.shields.io/badge/incidents%E2%86%92mechanisms-122-orange.svg)](incidents/)
...
07:54 — no human involved. Both are postmortems in this repo. So are 120
...
- **The memory** — 122 incident postmortems in this cut, 27 models in the registry,
  21 modes, 8 adapters + stub, 41 test suites guarding the guards.
...
Every failure you hit: `bin/incident.sh new` — that's how the 122 in this cut happened.
...
- Every failure becomes an incident; every incident becomes a mechanism. **122 in this cut.**
...
| [incidents/](incidents/) | 122 failures that became permanent protections |
