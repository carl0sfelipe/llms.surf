...
- Every failure becomes an incident; every recurring incident becomes code that refuses. **110 postmortems in this cut.**
...
[![Incidents](https://img.shields.io/badge/incidents%E2%86%92mechanisms-110-orange.svg)](incidents/)
...
07:54 — no human involved. Both are postmortems in this repo. So are 108
...
- **The memory** — 110 incident postmortems in this cut, 24 models in the registry,
...
Every failure you hit: `bin/incident.sh new` — that's how the 110 in this cut happened.
...
- Every failure becomes an incident; every incident becomes a mechanism. **110 in this cut.**
...
| [incidents/](incidents/) | 110 failures that became permanent protections |
