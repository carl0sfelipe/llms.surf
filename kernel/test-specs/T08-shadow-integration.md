...
VERIFICACAO: grep -m1 '^## Verdict:' kernel/test-specs/reports/T08.md

## Oráculo

- comando: bash kernel/test-specs/oracle.sh T08
- exit esperado: 0 (report em kernel/test-specs/reports/T08.md com
