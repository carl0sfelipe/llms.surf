...
VERIFICACAO: grep -m1 '^## Verdict:' kernel/test-specs/reports/T05.md

## Oráculo

- comando: bash kernel/test-specs/oracle.sh T05
- exit esperado: 0 (report em kernel/test-specs/reports/T05.md com
