...
VERIFICACAO: grep -m1 '^## Verdict:' kernel/test-specs/reports/T07.md

## Oráculo

- comando: bash kernel/test-specs/oracle.sh T07
- exit esperado: 0 (report em kernel/test-specs/reports/T07.md com
